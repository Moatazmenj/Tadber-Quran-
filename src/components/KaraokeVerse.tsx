...
export function KaraokeVerse({ verse, wordTimings, currentWordIndex, fontStyle, fontSize, isKaraokeDisabled }: KaraokeVerseProps) {
  ...
  if (isKaraokeDisabled || wordTimings.length === 0) {
    return (
      <div 
        dir="rtl" 
        className={cn(
            "leading-loose text-foreground text-center text-white",
